        ...
        <div class="header__wrapper">
            @auth
                ...
                -108 49 -134 104 -127 151 20 132 275 -34 458 -97 108 -194 150 -222 98z" />
                    ...
                    <p class="level__text">
                        <span class="level__description">
                            Уровень:
                        </span>
                        <span class="level__status">
                            Котёнок
                        </span>
                    </p>
                </a>
            ...
            @guest
            <div class="header__tips tips">
                <p class="tips__question">
                    А вы знали?
                </p>
                <a href="" class="tips__link">
                    Десятое задание можно решить в 10 раз быстрее!
                </a>
            </div>
            ...
            <div class="header__user user user--guest">
                <a href="{{ route('user-signup-view') }}" class="user__signup">Зарегистрироваться</a>
                <a href="{{ route('user-signin-view') }}" class="user__signin">Войти</a>
            </div>
            @endguest
        </div>
    </header>
